...
**FieldsV1** | [**SystemCollectionsHashtable**](.md) | FieldsV1 holds the first JSON version format as described in the &quot;&quot;FieldsV1&quot;&quot; type. +optional | [optional] 
...
```powershell
$V1ManagedFieldsEntry = Initialize-PSOpenAPIToolsV1ManagedFieldsEntry  -ApiVersion null `
 -FieldsType null `
 -FieldsV1 null `
 -Manager null `
 -Operation null `
...
```powershell
$V1ManagedFieldsEntry | ConvertTo-JSON
```
