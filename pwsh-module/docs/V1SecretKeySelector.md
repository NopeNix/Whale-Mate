...
**Optional** | **Boolean** | Specify whether the Secret or its key must be defined +optional | [optional] 

## Examples

- Prepare the resource
```powershell
$V1SecretKeySelector = Initialize-PSOpenAPIToolsV1SecretKeySelector  -Key null `
 -Name null `
 -Optional null
```
...
```powershell
$V1SecretKeySelector | ConvertTo-JSON
```
