# EdgeupdateschedulesInspectResponse
## Properties
...
```powershell
$EdgeupdateschedulesInspectResponse = Initialize-PSOpenAPIToolsEdgeupdateschedulesInspectResponse  -AgentImage portainer/agent:latest `
 -Created 1564897200 `
 -CreatedBy 1 `
 -EdgeGroupIds [1] `
 -EdgeStackId 1 `
...
```powershell
$EdgeupdateschedulesInspectResponse | ConvertTo-JSON
```
