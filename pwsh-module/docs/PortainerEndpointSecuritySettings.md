...
```powershell
$PortainerEndpointSecuritySettings = Initialize-PSOpenAPIToolsPortainerEndpointSecuritySettings  -AllowBindMountsForRegularUsers false `
...
```powershell
$PortainerEndpointSecuritySettings | ConvertTo-JSON
```
