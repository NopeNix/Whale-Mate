...
```powershell
$StacksSwarmStackFromFileContentPayload = Initialize-PSOpenAPIToolsStacksSwarmStackFromFileContentPayload  -Env null `
...
```powershell
$StacksSwarmStackFromFileContentPayload | ConvertTo-JSON
```
