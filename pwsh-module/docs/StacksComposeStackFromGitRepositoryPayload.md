...
```powershell
$StacksComposeStackFromGitRepositoryPayload = Initialize-PSOpenAPIToolsStacksComposeStackFromGitRepositoryPayload  -AdditionalFiles [[nz.compose.yml,  uat.compose.yml]] `
 -AutoUpdate null `
...
```powershell
$StacksComposeStackFromGitRepositoryPayload | ConvertTo-JSON
```
