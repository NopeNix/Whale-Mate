...
**StatusSummary** | [**GithubComPortainerPortainerEeApiHttpHandlerEdgestacksEdgeStackStatusSummary**](GithubComPortainerPortainerEeApiHttpHandlerEdgestacksEdgeStackStatusSummary.md) |  | [optional] 
...
```powershell
$GithubComPortainerPortainerEeApiHttpHandlerEdgestacksEdgeStackListResponseItem = Initialize-PSOpenAPIToolsGithubComPortainerPortainerEeApiHttpHandlerEdgestacksEdgeStackListResponseItem  -AlwaysCloneGitRepoForRelativePath false `
 -AutoUpdate null `
 -CreatedBy admin `
 -CreatedByUserId 1 `
 -CreationDate null `
...
```powershell
$GithubComPortainerPortainerEeApiHttpHandlerEdgestacksEdgeStackListResponseItem | ConvertTo-JSON
```
