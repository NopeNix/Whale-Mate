...
**Optional** | **Boolean** | Specify whether the ConfigMap must be defined +optional | [optional] 

## Examples

- Prepare the resource
```powershell
$V1ConfigMapEnvSource = Initialize-PSOpenAPIToolsV1ConfigMapEnvSource  -Name null `
 -Optional null
```

- Convert the resource to JSON
```powershell
$V1ConfigMapEnvSource | ConvertTo-JSON
```
