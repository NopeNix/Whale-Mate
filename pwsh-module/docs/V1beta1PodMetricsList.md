...
**Items** | [**V1beta1PodMetrics[]**](V1beta1PodMetrics.md) | List of pod metrics. | [optional] 
...
```powershell
$V1beta1PodMetricsList = Initialize-PSOpenAPIToolsV1beta1PodMetricsList  -ApiVersion null `
 -Items null `
 -Kind null `
 -Metadata null
```
...
```powershell
$V1beta1PodMetricsList | ConvertTo-JSON
```
