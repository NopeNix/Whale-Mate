...
#>
function Invoke-ResourceControlCreate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-ResourceControlCreate' | Write-Debug
        ...
        $LocalVarUri = '/resource_controls'

        if (!$Body) {
            throw "Error! The required parameter `Body` missing when calling resourceControlCreate."
        }
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'POST' `
                                ...
                                -ReturnType "PortainerResourceControl" `
...
None
#>
function Invoke-ResourceControlDelete {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [Int32]
    ...
    Process {
        'Calling method: Invoke-ResourceControlDelete' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $Configuration = Get-Configuration
        $LocalVarUri = '/resource_controls/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling resourceControlDelete."
        }
...
PortainerResourceControl
#>
function Invoke-ResourceControlUpdate {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [Int32]
    ...
    Process {
        'Calling method: Invoke-ResourceControlUpdate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/resource_controls/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling resourceControlUpdate."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))

        if (!$Body) {
            throw "Error! The required parameter `Body` missing when calling resourceControlUpdate."
        }
