...
function Invoke-SSLInspect {
    ...
    Process {
        'Calling method: Invoke-SSLInspect' | Write-Debug
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -ReturnType "PortainereeSSLSettings" `
...
function Invoke-SSLUpdate {
    ...
    Process {
        'Calling method: Invoke-SSLUpdate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$Body) {
            throw "Error! The required parameter `Body` missing when calling sSLUpdate."
        }
