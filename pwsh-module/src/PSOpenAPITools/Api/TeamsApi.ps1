...
function Invoke-TeamCreate {
    ...
    Process {
        'Calling method: Invoke-TeamCreate' | Write-Debug
        ...
        if (!$Body) {
            throw "Error! The required parameter `Body` missing when calling teamCreate."
        }
...
function Invoke-TeamDelete {
    ...
    Process {
        'Calling method: Invoke-TeamDelete' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $Configuration = Get-Configuration
        $LocalVarUri = '/teams/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling teamDelete."
        }
...
function Invoke-TeamInspect {
    ...
    Process {
        'Calling method: Invoke-TeamInspect' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/teams/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling teamInspect."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
...
function Invoke-TeamList {
    ...
    Process {
        'Calling method: Invoke-TeamList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if ($OnlyLedTeams) {
            $LocalVarQueryParameters['onlyLedTeams'] = $OnlyLedTeams
        }
...
function Invoke-TeamUpdate {
    ...
    Process {
        'Calling method: Invoke-TeamUpdate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/teams/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling teamUpdate."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))

        if (!$Body) {
            throw "Error! The required parameter `Body` missing when calling teamUpdate."
        }
