...
function Invoke-TagCreate {
    ...
    Process {
        'Calling method: Invoke-TagCreate' | Write-Debug
        ...
        if (!$Body) {
            throw "Error! The required parameter `Body` missing when calling tagCreate."
        }
...
function Invoke-TagDelete {
    ...
    Process {
        'Calling method: Invoke-TagDelete' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/tags/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling tagDelete."
        }
...
function Invoke-TagList {
    ...
    Process {
        'Calling method: Invoke-TagList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
