...
#>
function Invoke-LicensesAttach {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-LicensesAttach' | Write-Debug
        ...
        if (!$Body) {
            throw "Error! The required parameter `Body` missing when calling licensesAttach."
        }
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'POST' `
                                ...
                                -ReturnType "LicensesAttachResponse" `
...
None
#>
function Invoke-LicensesDelete {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-LicensesDelete' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/licenses/remove'

        if (!$Body) {
            throw "Error! The required parameter `Body` missing when calling licensesDelete."
        }
...
function Invoke-LicensesInfo {
    ...
    Process {
        'Calling method: Invoke-LicensesInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "LicensesLicenseInfo" `
                                -IsBodyNullable $false
...
function Invoke-LicensesList {
    ...
    Process {
        'Calling method: Invoke-LicensesList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "LiblicensePortainerLicense[]" `
                                -IsBodyNullable $false
