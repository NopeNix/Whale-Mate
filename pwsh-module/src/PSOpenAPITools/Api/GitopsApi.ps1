...
GitopsFileResponse
#>
function Invoke-GitOperationRepoFilePreview {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-GitOperationRepoFilePreview' | Write-Debug
        ...
        $LocalVarUri = '/gitops/repo/file/preview'

        if (!$Body) {
            throw "Error! The required parameter `Body` missing when calling gitOperationRepoFilePreview."
        }
...
String[]
#>
function Invoke-GitOperationRepoFilesSearch {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-GitOperationRepoFilesSearch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/gitops/repo/files/search'
        ...
        if (!$Body) {
            throw "Error! The required parameter `Body` missing when calling gitOperationRepoFilesSearch."
        }
...
#>
function Invoke-GitOperationRepoHelmValues {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-GitOperationRepoHelmValues' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/gitops/repo/helm/values'

        if (!$Body) {
            throw "Error! The required parameter `Body` missing when calling gitOperationRepoHelmValues."
        }
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'POST' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "GitopsHelmValuesPreviewResponse" `
                                -IsBodyNullable $false
...
String[]
#>
function Invoke-GitOperationRepoRefs {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-GitOperationRepoRefs' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$Body) {
            throw "Error! The required parameter `Body` missing when calling gitOperationRepoRefs."
        }
