...
#>
function Invoke-AuthenticateUser {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-AuthenticateUser' | Write-Debug
        ...
        if (!$Body) {
            throw "Error! The required parameter `Body` missing when calling authenticateUser."
        }
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'POST' `
                                ...
                                -ReturnType "AuthAuthenticateResponse" `
...
function Confirm-OAuth {
    ...
    Process {
        'Calling method: Confirm-OAuth' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/auth/oauth/validate'

        if (!$Body) {
            throw "Error! The required parameter `Body` missing when calling validateOAuth."
        }
