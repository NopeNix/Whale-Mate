...
SupportDebugLogPayload
#>
function Get-DebugLogStatus {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Get-DebugLogStatus' | Write-Debug
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -ReturnType "SupportDebugLogPayload" `
...
function Set-DebugLogStatus {
    ...
    Process {
        'Calling method: Set-DebugLogStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$Body) {
            throw "Error! The required parameter `Body` missing when calling setDebugLogStatus."
        }
...
None
#>
function Invoke-SupportBundleDownload {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Invoke-SupportBundleDownload' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
