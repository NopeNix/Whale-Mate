...
V1beta1PodMetricsList<PSCustomObject>
#>

function Initialize-V1beta1PodMetricsList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => V1beta1PodMetricsList' | Write-Debug
...
Convert from JSON to V1beta1PodMetricsList<PSCustomObject>
...
V1beta1PodMetricsList<PSCustomObject>
#>
function ConvertFrom-JsonToV1beta1PodMetricsList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => V1beta1PodMetricsList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V1beta1PodMetricsList
