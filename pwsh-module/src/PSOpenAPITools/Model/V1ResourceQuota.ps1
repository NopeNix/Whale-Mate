...
.PARAMETER Spec
Spec defines the desired quota. https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status +optional
.PARAMETER Status
Status defines the actual enforced quota and its current usage. https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status +optional
.OUTPUTS

V1ResourceQuota<PSCustomObject>
#>

function Initialize-V1ResourceQuota {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => V1ResourceQuota' | Write-Debug
...
Convert from JSON to V1ResourceQuota<PSCustomObject>
...
V1ResourceQuota<PSCustomObject>
#>
function ConvertFrom-JsonToV1ResourceQuota {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => V1ResourceQuota' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V1ResourceQuota
        $AllProperties = ("apiVersion", "kind", "metadata", "spec", "status")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "spec"))) { #optional property not found
            $Spec = $null
        } else {
