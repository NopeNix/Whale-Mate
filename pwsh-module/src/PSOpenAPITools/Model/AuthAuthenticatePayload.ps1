...
AuthAuthenticatePayload<PSCustomObject>
#>

function Initialize-AuthAuthenticatePayload {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AuthAuthenticatePayload' | Write-Debug
...
Convert from JSON to AuthAuthenticatePayload<PSCustomObject>
...
AuthAuthenticatePayload<PSCustomObject>
#>
function ConvertFrom-JsonToAuthAuthenticatePayload {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AuthAuthenticatePayload' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AuthAuthenticatePayload
        $AllProperties = ("apiKey", "password", "username")
