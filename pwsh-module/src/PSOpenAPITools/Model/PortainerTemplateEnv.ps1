...
PortainerTemplateEnv<PSCustomObject>
#>

function Initialize-PortainerTemplateEnv {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PortainerTemplateEnv' | Write-Debug
...
Convert from JSON to PortainerTemplateEnv<PSCustomObject>
...
PortainerTemplateEnv<PSCustomObject>
#>
function ConvertFrom-JsonToPortainerTemplateEnv {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PortainerTemplateEnv' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PortainerTemplateEnv
        $AllProperties = ("default", "description", "label", "name", "preset", "select")
