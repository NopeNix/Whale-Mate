...
V1ConfigMapEnvSource<PSCustomObject>
#>

function Initialize-V1ConfigMapEnvSource {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => V1ConfigMapEnvSource' | Write-Debug
...
Convert from JSON to V1ConfigMapEnvSource<PSCustomObject>
...
V1ConfigMapEnvSource<PSCustomObject>
#>
function ConvertFrom-JsonToV1ConfigMapEnvSource {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => V1ConfigMapEnvSource' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V1ConfigMapEnvSource
        $AllProperties = ("name", "optional")
