...
PortainerLDAPSearchSettings<PSCustomObject>
#>

function Initialize-PortainerLDAPSearchSettings {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PortainerLDAPSearchSettings' | Write-Debug
...
Convert from JSON to PortainerLDAPSearchSettings<PSCustomObject>
...
PortainerLDAPSearchSettings<PSCustomObject>
#>
function ConvertFrom-JsonToPortainerLDAPSearchSettings {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PortainerLDAPSearchSettings' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PortainerLDAPSearchSettings
        $AllProperties = ("BaseDN", "Filter", "UserNameAttribute")
