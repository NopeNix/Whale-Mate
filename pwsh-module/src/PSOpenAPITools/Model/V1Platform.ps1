...
V1Platform<PSCustomObject>
#>

function Initialize-V1Platform {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => V1Platform' | Write-Debug
...
Convert from JSON to V1Platform<PSCustomObject>
...
V1Platform<PSCustomObject>
#>
function ConvertFrom-JsonToV1Platform {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => V1Platform' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V1Platform
        $AllProperties = ("architecture", "os", "os.features", "os.version", "variant")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "os.features"))) { #optional property not found
            $OsFeatures = $null
        } else {
            $OsFeatures = $JsonParameters.PSobject.Properties["os.features"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "os.version"))) { #optional property not found
            $OsVersion = $null
        } else {
            $OsVersion = $JsonParameters.PSobject.Properties["os.version"].value
        }
