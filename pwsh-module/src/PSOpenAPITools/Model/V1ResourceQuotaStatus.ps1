...
V1ResourceQuotaStatus<PSCustomObject>
#>

function Initialize-V1ResourceQuotaStatus {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => V1ResourceQuotaStatus' | Write-Debug
...
Convert from JSON to V1ResourceQuotaStatus<PSCustomObject>
...
V1ResourceQuotaStatus<PSCustomObject>
#>
function ConvertFrom-JsonToV1ResourceQuotaStatus {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => V1ResourceQuotaStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V1ResourceQuotaStatus
        $AllProperties = ("hard", "used")
