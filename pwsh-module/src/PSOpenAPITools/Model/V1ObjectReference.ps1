...
V1ObjectReference<PSCustomObject>
#>

function Initialize-V1ObjectReference {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => V1ObjectReference' | Write-Debug
...
Convert from JSON to V1ObjectReference<PSCustomObject>
...
V1ObjectReference<PSCustomObject>
#>
function ConvertFrom-JsonToV1ObjectReference {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => V1ObjectReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V1ObjectReference
        $AllProperties = ("apiVersion", "fieldPath", "kind", "name", "namespace", "resourceVersion", "uid")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "fieldPath"))) { #optional property not found
            $FieldPath = $null
        } else {
            $FieldPath = $JsonParameters.PSobject.Properties["fieldPath"].value
        }
