...
V1OwnerReference<PSCustomObject>
#>

function Initialize-V1OwnerReference {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => V1OwnerReference' | Write-Debug
...
Convert from JSON to V1OwnerReference<PSCustomObject>
...
V1OwnerReference<PSCustomObject>
#>
function ConvertFrom-JsonToV1OwnerReference {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => V1OwnerReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V1OwnerReference
        $AllProperties = ("apiVersion", "blockOwnerDeletion", "controller", "kind", "name", "uid")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "blockOwnerDeletion"))) { #optional property not found
            $BlockOwnerDeletion = $null
        } else {
            $BlockOwnerDeletion = $JsonParameters.PSobject.Properties["blockOwnerDeletion"].value
        }
