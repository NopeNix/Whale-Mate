...
V1NamespaceStatus<PSCustomObject>
#>

function Initialize-V1NamespaceStatus {
    [CmdletBinding()]
    Param (
        ...
        [ValidateSet("Active", "Terminating")]
        [PSCustomObject]
        ${Phase}
    )

    Process {
        'Creating PSCustomObject: PSOpenAPITools => V1NamespaceStatus' | Write-Debug
...
Convert from JSON to V1NamespaceStatus<PSCustomObject>
...
V1NamespaceStatus<PSCustomObject>
#>
function ConvertFrom-JsonToV1NamespaceStatus {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => V1NamespaceStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V1NamespaceStatus
        $AllProperties = ("conditions", "phase")
