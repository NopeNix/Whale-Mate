...
V1HTTPGetAction<PSCustomObject>
#>

function Initialize-V1HTTPGetAction {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => V1HTTPGetAction' | Write-Debug
...
Convert from JSON to V1HTTPGetAction<PSCustomObject>
...
V1HTTPGetAction<PSCustomObject>
#>
function ConvertFrom-JsonToV1HTTPGetAction {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => V1HTTPGetAction' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V1HTTPGetAction
        $AllProperties = ("host", "httpHeaders", "path", "port", "scheme")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "httpHeaders"))) { #optional property not found
            $HttpHeaders = $null
        } else {
            $HttpHeaders = $JsonParameters.PSobject.Properties["httpHeaders"].value
        }
