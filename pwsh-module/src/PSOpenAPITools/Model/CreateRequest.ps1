...
CreateRequest<PSCustomObject>
#>

function Initialize-CreateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CreateRequest' | Write-Debug
...
Convert from JSON to CreateRequest<PSCustomObject>
...
CreateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToCreateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CreateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CreateRequest
        $AllProperties = ("provider", "name", "credentials")
