...
ModelsK8sIngressInfo<PSCustomObject>
#>

function Initialize-ModelsK8sIngressInfo {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ModelsK8sIngressInfo' | Write-Debug
...
Convert from JSON to ModelsK8sIngressInfo<PSCustomObject>
...
ModelsK8sIngressInfo<PSCustomObject>
#>
function ConvertFrom-JsonToModelsK8sIngressInfo {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ModelsK8sIngressInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ModelsK8sIngressInfo
        $AllProperties = ("Annotations", "ClassName", "CreationDate", "Hosts", "Labels", "Name", "Namespace", "Paths", "TLS", "Type", "UID")
