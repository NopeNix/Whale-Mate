...
V1SecretKeySelector<PSCustomObject>
#>

function Initialize-V1SecretKeySelector {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => V1SecretKeySelector' | Write-Debug
...
Convert from JSON to V1SecretKeySelector<PSCustomObject>
...
V1SecretKeySelector<PSCustomObject>
#>
function ConvertFrom-JsonToV1SecretKeySelector {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => V1SecretKeySelector' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V1SecretKeySelector
