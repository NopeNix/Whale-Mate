...
V1SELinuxOptions<PSCustomObject>
#>

function Initialize-V1SELinuxOptions {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => V1SELinuxOptions' | Write-Debug
...
Convert from JSON to V1SELinuxOptions<PSCustomObject>
...
V1SELinuxOptions<PSCustomObject>
#>
function ConvertFrom-JsonToV1SELinuxOptions {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => V1SELinuxOptions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V1SELinuxOptions
