...
KubernetesK8sCronJob<PSCustomObject>
#>

function Initialize-KubernetesK8sCronJob {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => KubernetesK8sCronJob' | Write-Debug
...
Convert from JSON to KubernetesK8sCronJob<PSCustomObject>
...
KubernetesK8sCronJob<PSCustomObject>
#>
function ConvertFrom-JsonToKubernetesK8sCronJob {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => KubernetesK8sCronJob' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in KubernetesK8sCronJob
        $AllProperties = ("Command", "Id", "IsSystem", "Jobs", "Name", "Namespace", "Schedule", "Suspend", "Timezone")
