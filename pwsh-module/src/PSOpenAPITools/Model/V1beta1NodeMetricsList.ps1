...
V1beta1NodeMetricsList<PSCustomObject>
#>

function Initialize-V1beta1NodeMetricsList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => V1beta1NodeMetricsList' | Write-Debug
...
Convert from JSON to V1beta1NodeMetricsList<PSCustomObject>
...
V1beta1NodeMetricsList<PSCustomObject>
#>
function ConvertFrom-JsonToV1beta1NodeMetricsList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => V1beta1NodeMetricsList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V1beta1NodeMetricsList
        $AllProperties = ("apiVersion", "items", "kind", "metadata")
