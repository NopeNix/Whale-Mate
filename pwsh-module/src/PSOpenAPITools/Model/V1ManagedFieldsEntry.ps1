...
V1ManagedFieldsEntry<PSCustomObject>
#>

function Initialize-V1ManagedFieldsEntry {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => V1ManagedFieldsEntry' | Write-Debug
...
Convert from JSON to V1ManagedFieldsEntry<PSCustomObject>
...
V1ManagedFieldsEntry<PSCustomObject>
#>
function ConvertFrom-JsonToV1ManagedFieldsEntry {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => V1ManagedFieldsEntry' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V1ManagedFieldsEntry
        $AllProperties = ("apiVersion", "fieldsType", "fieldsV1", "manager", "operation", "subresource", "time")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "fieldsType"))) { #optional property not found
            $FieldsType = $null
        } else {
            $FieldsType = $JsonParameters.PSobject.Properties["fieldsType"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "fieldsV1"))) { #optional property not found
            $FieldsV1 = $null
        } else {
            $FieldsV1 = $JsonParameters.PSobject.Properties["fieldsV1"].value
        }
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "subresource"))) { #optional property not found
            $Subresource = $null
        } else {
            $Subresource = $JsonParameters.PSobject.Properties["subresource"].value
        }
