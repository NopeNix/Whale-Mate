...
SslName<PSCustomObject>
#>

function Initialize-SslName {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SslName' | Write-Debug
...
Convert from JSON to SslName<PSCustomObject>
...
SslName<PSCustomObject>
#>
function ConvertFrom-JsonToSslName {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SslName' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SslName
        $AllProperties = ("Country", "Locality", "SerialNumber", "StreetAddress")
