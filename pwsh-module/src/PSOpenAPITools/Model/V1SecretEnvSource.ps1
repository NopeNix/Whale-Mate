...
V1SecretEnvSource<PSCustomObject>
#>

function Initialize-V1SecretEnvSource {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => V1SecretEnvSource' | Write-Debug
...
Convert from JSON to V1SecretEnvSource<PSCustomObject>
...
V1SecretEnvSource<PSCustomObject>
#>
function ConvertFrom-JsonToV1SecretEnvSource {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => V1SecretEnvSource' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V1SecretEnvSource
