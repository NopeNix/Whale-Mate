...
ModelsK8sIngressController<PSCustomObject>
#>

function Initialize-ModelsK8sIngressController {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ModelsK8sIngressController' | Write-Debug
...
Convert from JSON to ModelsK8sIngressController<PSCustomObject>
...
ModelsK8sIngressController<PSCustomObject>
#>
function ConvertFrom-JsonToModelsK8sIngressController {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ModelsK8sIngressController' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ModelsK8sIngressController
        $AllProperties = ("Availability", "ClassName", "Name", "New", "Type", "Used")
