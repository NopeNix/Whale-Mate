...
ModelsPod<PSCustomObject>
#>

function Initialize-ModelsPod {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ModelsPod' | Write-Debug
...
Convert from JSON to ModelsPod<PSCustomObject>
...
ModelsPod<PSCustomObject>
#>
function ConvertFrom-JsonToModelsPod {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ModelsPod' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ModelsPod
        $AllProperties = ("ContainerName", "CreationDate", "Image", "ImagePullPolicy", "Name", "NodeName", "PodIP", "Status", "Uid")
