...
.PARAMETER DeletionGracePeriodSeconds
...
V1ObjectMeta<PSCustomObject>
#>

function Initialize-V1ObjectMeta {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => V1ObjectMeta' | Write-Debug
...
Convert from JSON to V1ObjectMeta<PSCustomObject>
...
V1ObjectMeta<PSCustomObject>
#>
function ConvertFrom-JsonToV1ObjectMeta {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => V1ObjectMeta' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V1ObjectMeta
        $AllProperties = ("annotations", "creationTimestamp", "deletionGracePeriodSeconds", "deletionTimestamp", "finalizers", "generateName", "generation", "labels", "managedFields", "name", "namespace", "ownerReferences", "resourceVersion", "selfLink", "uid")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "deletionGracePeriodSeconds"))) { #optional property not found
            $DeletionGracePeriodSeconds = $null
        } else {
            $DeletionGracePeriodSeconds = $JsonParameters.PSobject.Properties["deletionGracePeriodSeconds"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "deletionTimestamp"))) { #optional property not found
            $DeletionTimestamp = $null
        } else {
            $DeletionTimestamp = $JsonParameters.PSobject.Properties["deletionTimestamp"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "finalizers"))) { #optional property not found
            $Finalizers = $null
        } else {
            $Finalizers = $JsonParameters.PSobject.Properties["finalizers"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "generateName"))) { #optional property not found
            $GenerateName = $null
        } else {
            $GenerateName = $JsonParameters.PSobject.Properties["generateName"].value
        }
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "managedFields"))) { #optional property not found
            $ManagedFields = $null
        } else {
            $ManagedFields = $JsonParameters.PSobject.Properties["managedFields"].value
        }
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "ownerReferences"))) { #optional property not found
            $OwnerReferences = $null
        } else {
            $OwnerReferences = $JsonParameters.PSobject.Properties["ownerReferences"].value
        }
