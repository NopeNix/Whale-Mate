...
Metrics for all containers are collected within the same time window. +listType=atomic
.PARAMETER Kind
...
V1beta1PodMetrics<PSCustomObject>
#>

function Initialize-V1beta1PodMetrics {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => V1beta1PodMetrics' | Write-Debug
...
Convert from JSON to V1beta1PodMetrics<PSCustomObject>
...
V1beta1PodMetrics<PSCustomObject>
#>
function ConvertFrom-JsonToV1beta1PodMetrics {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => V1beta1PodMetrics' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V1beta1PodMetrics
        $AllProperties = ("apiVersion", "containers", "kind", "metadata", "timestamp", "window")
