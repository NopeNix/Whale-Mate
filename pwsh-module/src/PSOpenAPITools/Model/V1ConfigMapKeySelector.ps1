...
V1ConfigMapKeySelector<PSCustomObject>
#>

function Initialize-V1ConfigMapKeySelector {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => V1ConfigMapKeySelector' | Write-Debug
...
Convert from JSON to V1ConfigMapKeySelector<PSCustomObject>
...
V1ConfigMapKeySelector<PSCustomObject>
#>
function ConvertFrom-JsonToV1ConfigMapKeySelector {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => V1ConfigMapKeySelector' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V1ConfigMapKeySelector
        $AllProperties = ("key", "name", "optional")
